...
mixin _$ResendOtpState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(String message, String data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(String message, String data)? success,
...
abstract class Loading implements ResendOtpState {
...
class _$SuccessImpl implements Success {
  const _$SuccessImpl({required this.message, required this.data});
  ...
  @override
  String toString() {
    return 'ResendOtpState.success(message: $message, data: $data)';
  }
...
abstract class Success implements ResendOtpState {
  const factory Success(
      {required final String message,
      required final String data}) = _$SuccessImpl;
...
abstract class Error implements ResendOtpState {
