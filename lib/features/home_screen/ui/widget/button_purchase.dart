...
class ButtonPurchase extends StatelessWidget {
  const ButtonPurchase({super.key});

  @override
  Widget build(BuildContext context) {
    return BlocBuilder<PurchaseStoreCubit, PurchaseStoreState>(
  ...
  void validateThenDoPurchaseStore(BuildContext context) {
      if (context.read<PurchaseStoreCubit>().formKey.currentState!.validate()) {
          context.read<PurchaseStoreCubit>().emitPurchaseStoreStates();
      }
  }
}
